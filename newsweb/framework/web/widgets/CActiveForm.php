...
class CActiveForm extends CWidget
{
	 ...
	 * @return string the generated input field
	 */
	public function textField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		return CHtml::activeTextField($model,$attribute,$htmlOptions,$flag);
	}
	 ...
	 * @return string the generated input field
	 */
	public function hiddenField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		return CHtml::activeHiddenField($model,$attribute,$htmlOptions,$flag);
	}
	 ...
	 */
	public function dropDownList($model,$attribute,$data,$htmlOptions=array(),$flag=false)
	{
		return CHtml::activeDropDownList($model,$attribute,$data,$htmlOptions,$flag);
	}
