...
EOD;
	 ...
	 */
	public static function activeTextField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		self::clientChange('change',$htmlOptions);
	 ...
	 * @since 1.1.11
	 */
	public static function activeUrlField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		self::clientChange('change',$htmlOptions);
	 ...
	 * @since 1.1.11
	 */
	public static function activeEmailField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		self::clientChange('change',$htmlOptions);
	 ...
	 * @since 1.1.11
	 */
	public static function activeNumberField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		self::clientChange('change',$htmlOptions);
	 ...
	 * @since 1.1.11
	 */
	public static function activeRangeField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		self::clientChange('change',$htmlOptions);
	 ...
	 * @since 1.1.11
	 */
	public static function activeDateField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		self::clientChange('change',$htmlOptions);
	 ...
	 * @see activeInputField
	 */
	public static function activeHiddenField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
	 ...
	 * @see activeInputField
	 */
	public static function activePasswordField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		self::clientChange('change',$htmlOptions);
	 ...
	 * @see clientChange
	 */
	public static function activeTextArea($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		self::clientChange('change',$htmlOptions);
		if($model->hasErrors($attribute))
	 ...
	 * @see activeInputField
	 */
	public static function activeFileField($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
	 ...
	 * @see activeInputField
	 */
	public static function activeRadioButton($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		if(!isset($htmlOptions['value']))
			$htmlOptions['value']=1;
	 ...
	 * @see activeInputField
	 */
	public static function activeCheckBox($model,$attribute,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		if(!isset($htmlOptions['value']))
			$htmlOptions['value']=1;
	 ...
	 * @see listData
	 */
	public static function activeDropDownList($model,$attribute,$data,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
	 ...
	 * @see checkBoxList
	 */
	public static function activeCheckBoxList($model,$attribute,$data,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		$selection=self::resolveValue($model,$attribute);
		if($model->hasErrors($attribute))
	 ...
	 * @see radioButtonList
	 */
	public static function activeRadioButtonList($model,$attribute,$data,$htmlOptions=array(),$flag=false)
	{
		self::resolveNameID($model,$attribute,$htmlOptions,$flag);
		$selection=self::resolveValue($model,$attribute);
		if($model->hasErrors($attribute))
	 ...
	 */
	public static function resolveNameID($model,&$attribute,&$htmlOptions,$flag=false)
	{
		if(!isset($htmlOptions['name']))
			$htmlOptions['name']=self::resolveName($model,$attribute,$flag);
		if(!isset($htmlOptions['id']))
	 ...
	 */
	public static function resolveName($model,&$attribute,$flag=false)
	{
